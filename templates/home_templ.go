...
func HomePage(date string, currentData data.WeeklyStats, settings data.Settings, calorieGoal, expectedDuration float64, weightChart string, hasCurrentWeek, needsAdjustment, isHTMX bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if isHTMX {
			templ_7745c5c3_Err = Content(date, currentData, settings, calorieGoal, expectedDuration, weightChart, hasCurrentWeek, needsAdjustment).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
...
func Card(props CardProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.iconSrc != "" {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<img alt=\"trendline icon\" g src=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		if !(props.value > 0) {
			...
			if !(math.IsNaN(props.changeRate)) && !(props.changeRate == 0) {
				...
				if props.positiveChange {
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<img alt=\"arrow down icon\" class=\"h-4\" src=\"/static/img/arrow-down.svg\"> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<img alt=\"arrow up icon\" class=\"h-4\" src=\"/static/img/arrow-up.svg\"> ")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
